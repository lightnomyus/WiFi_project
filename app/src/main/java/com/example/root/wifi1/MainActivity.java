    ...
    public void onShowNetworkStatus(View v) {
        ...
        if(mComMgr != null){
            ...
            if( networkInfo != null && networkInfo.isConnected() ){
                //toast message if network is active and connected
                Toast.makeText(this, "Network is Available Now", Toast.LENGTH_SHORT).show();
            } else{
                //toast message if network isn't active or no internet connection
